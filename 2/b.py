...
# Observed/training input and output. 0 NAND 0 = 1, 0 NAND 1 = 1, 1 NAND 0 = 1 and 1 NAND 1 = 0
...
for epoch in range(25_000):
    model.loss(x_train[:, 0].reshape(-1 , 1), x_train[:, 1].reshape(-1, 1), y_train).backward()
    optimizer.step()
    optimizer.zero_grad()
